...
internal sealed class StickFigurePane : Control
{
    ...
    {
        var bounds = Bounds;
        context.FillRectangle(DojoPalette.PaneBrush, new Rect(bounds.Size));
        context.DrawRectangle(
            null,
            new Pen(DojoPalette.PaneEdgeBrush, 1.5),
        ...
        {
            var fill = new SolidColorBrush(Color.FromArgb(170, 179, 58, 43));
            var edge = new Pen(new SolidColorBrush(Color.FromArgb(200, 111, 168, 122)), 0.8);
        ...
        if (_meshIndices.Length == 0)
        {
            foreach (var limb in _limbs)
            {
                ...
                var edgePen = new Pen(DojoPalette.BambooBrush, thickness + 2.5, lineCap: PenLineCap.Round);
                var fillPen = new Pen(DojoPalette.LacquerBrush, thickness, lineCap: PenLineCap.Round);
            ...
            if (_head is { } head)
            {
                ...
                context.DrawEllipse(DojoPalette.GoldBrush, new Pen(DojoPalette.BambooBrush, 1.5), p, r, r);
            }
        }

        var guidePen = new Pen(new SolidColorBrush(Color.FromArgb(140, 111, 168, 122)), 1.2, lineCap: PenLineCap.Round);
        ...
        foreach (var c in _jointDots)
        {
            ...
            context.DrawEllipse(DojoPalette.BambooBrightBrush, null, p, 3.0, 3.0);
        }

        var overlayPen = new Pen(DojoPalette.GoldBrush, 2.4, lineCap: PenLineCap.Round);
        var stringPen = new Pen(DojoPalette.WashiBrush, 1.6, lineCap: PenLineCap.Round);
        ...
        double width)
    {
        ...
        var pen = new Pen(new SolidColorBrush(Color.FromArgb(160, 63, 107, 74)), 1.5);
